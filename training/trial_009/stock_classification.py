...
from net import MyChainLSTM, MyChainBiDirectionalLSTM, MyChainLSTM2
...
def main():
    ...
    model = MyChainBiDirectionalLSTM(in_size=9, hidden_size=5, seq_size=20, out_size=len(y_axis),
    ...
    train_data = stock_dataset.MyStockDataset2(train_pairs, y_axis)
    test_data = stock_dataset.MyStockDataset2(test_pairs, y_axis)
